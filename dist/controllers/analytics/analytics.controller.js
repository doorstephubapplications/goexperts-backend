...
// ============================================================
async function executeReport(req, res, next, reportName, fetcher) {
    try {
        ...
        const range = AnalyticsService.getDateRange(filter, customStart, customEnd);
        // 3. Query
...
export const getDashboardStats = async (req, res, next) => {
    await executeReport(req, res, next, "Dashboard", (range) => AnalyticsService.getExecutiveDashboardStats(range));
};
export const getUserStats = async (req, res, next) => {
    await executeReport(req, res, next, "Users", (range) => AnalyticsService.getUserAnalytics(range));
};
export const getProjectStats = async (req, res, next) => {
    await executeReport(req, res, next, "Projects", (range) => AnalyticsService.getProjectAnalytics(range));
};
export const getStartupStats = async (req, res, next) => {
    await executeReport(req, res, next, "Startups", (range) => AnalyticsService.getStartupAnalytics(range));
};
export const getInvestmentStats = async (req, res, next) => {
    await executeReport(req, res, next, "Investments", (range) => AnalyticsService.getInvestmentAnalytics(range));
};
export const getFinancialStats = async (req, res, next) => {
    await executeReport(req, res, next, "Financials", (range) => AnalyticsService.getFinancialAnalytics(range));
};
export const getSupportStats = async (req, res, next) => {
    await executeReport(req, res, next, "Support", (range) => AnalyticsService.getSupportAnalytics(range));
};
