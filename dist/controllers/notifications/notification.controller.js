...
export const updateChannelConfig = async (req, res, next) => {
    try {
        const { id } = req.params;
...
// ============================================================
export const getNotificationDashboardStats = async (req, res, next) => {
    try {
        const [total, queued, sent, failed, emailSent, whatsappSent, smsSent, pushSent, inAppSent, emailFailed, whatsappFailed, smsFailed, pushFailed, inAppFailed, retriesCount, readCount,] = await Promise.all([
