...
export const getDashboardStats = async (req, res, next) => {
    try {
        const [users, freelancers, clients, investors, founders, projects, tasks, payments, subscriptions, support_tickets, startup_ideas, investments, marketing_campaigns,] = await Promise.all([
            prisma.user.count(),
