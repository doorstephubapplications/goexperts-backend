...
export const getCustomReport = async (req, res, next) => {
    try {
        const { source = "users", // users, projects, investments, support
        startDate, endDate, role, status, country, city, category, technology, priority, exportFormat, // csv, excel, pdf
         } = req.query;
