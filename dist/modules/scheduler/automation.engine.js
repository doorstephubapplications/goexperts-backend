...
export class AutomationEngine {
     ...
     */
    static async trigger(event, triggerEntityId, contextData) {
        try {
     ...
     */
    static async evaluateAndExecuteRule(rule, triggerEntityId, contextData) {
        ...
        for (const [key, expected] of Object.entries(conditions)) {
            ...
            if (expected && typeof expected === "object") {
                ...
                if ("eq" in expected && actual !== expected.eq)
                    return false;
                if ("neq" in expected && actual === expected.neq)
                    return false;
     ...
     */
    static async executeAction(action, contextData) {
