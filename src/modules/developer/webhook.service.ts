...
export class WebhookService {
   ...
   */
  static async triggerEvent(event: string, payloadObj: any) {
   ...
   */
  static async replayDelivery(deliveryId: string): Promise<boolean> {
    ...
    return this.dispatchWebhook(
      ...
      delivery.event,
      delivery.payload,
      0 // reset retry count for manual replays
    );
  }
}
